 ...
 * @author Ragha
 */
public class DataPreprocessing extends javax.swing.JPanel
{
    public static final String ID = "Setup Preprocessors";
    private static DataPreprocessing instance;

    public static DataPreprocessing getInstance()
    {
        return instance;
    }
...
//        pnlOutputProcessors.validate();
    ...
    private void initComponents() {
        ...
        pnlInputProcessors.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(DataPreprocessing.class, "DataPreprocessing.pnlInputProcessors.border.title_1"))); // NOI18N
        pnlInputProcessors.setLayout(new javax.swing.BoxLayout(pnlInputProcessors, javax.swing.BoxLayout.LINE_AXIS));

        pnlOutputProcessors.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(DataPreprocessing.class, "DataPreprocessing.pnlOutputProcessors.border.title_1"))); // NOI18N
