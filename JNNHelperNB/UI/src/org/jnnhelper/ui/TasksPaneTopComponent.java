 ...
 */
final class TasksPaneTopComponent extends TopComponent implements LookupListener
{
...
//        setIcon(Utilities.loadImage(ICON_PATH, true));
    ...
    {
        Lookup.Template tpl = new Lookup.Template(Boolean.class);
        result = TrainerTopComponent.getDefault().getLookup().lookup(tpl);
    ...
    final static class ResolvableHelper implements Serializable
    {
        ...
        {
            return TasksPaneTopComponent.getDefault();
        }
    }
