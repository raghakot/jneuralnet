 ...
 */
@ConvertAsProperties(
    dtd="-//org.jnnhelper.ui.analyzer//Analyzer//EN",
    autostore=false
)
...
//    static final String ICON_PATH = "SET/PATH/TO/ICON/HERE";
    ...
    private final Analyzer pnlAnalyzer;
...
//        setIcon(ImageUtilities.loadImage(ICON_PATH, true));
	...
	putClientProperty(TopComponent.PROP_UNDOCKING_DISABLED, Boolean.TRUE);
        ...
        pnlAnalyzer = new Analyzer();
        jScrollPane1.setViewportView(pnlAnalyzer);
    }
    ...
    Object readProperties(java.util.Properties p) {
        AnalyzerTopComponent singleton = AnalyzerTopComponent.getDefault();
