 ...
 * @author Ragha
 */
public class DataBuilder extends javax.swing.JPanel
{
    ...
    private HashMap<String, AbstractDataStore> mapStores;
    ...
    public DataBuilder()
    {
        ...
        mapStores = Configuration.getInstance().getMapDataStores()
                .getUnWrappedPluginMap(AbstractDataStore.class, false);
        
        boolean isScpSet = false;
        for(AbstractDataStore ads : mapStores.values())
        {
            cbxDataStore.addItem(ads.getName());
            if(!isScpSet)
            {
                scpConfigPnl.setViewportView(ads.getConfigPanel());
                isScpSet = true;
            }
        }
                ...
                if(evt.getPropertyName().equals("neuralNetwork"))
                {
                    ...
                    if(nn != null) {
                        nn.getTeacher().getTrainingDataRepository()
                               .setTotalAvailableSet(totalData);
                    }
                }
            }
        });
    ...
    private void btnAddDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddDataActionPerformed
        ...
        Configuration.getInstance().getNeuralNetwork().getTeacher()
                .getTrainingDataRepository().setTotalAvailableSet(totalData);
    ...
    private void btnSaveDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveDataActionPerformed
        ...
        {
            MainWindow.getInstance().getStatusBar()
                    .showMessage("Save failed due to: "+ e.getMessage(),
                    Color.RED);
        }        
    ...
    private void btnLoadDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadDataActionPerformed
        ...
        catch(Exception e)
        {
            e.printStackTrace();
            MainWindow.getInstance().getStatusBar()
                    .showMessage("Load failed due to:" + e.getMessage(),
                    Color.RED);
        }
        ...
        {
            MainWindow.getInstance().getStatusBar()
                    .showMessage("Data is incompatible " +
                    "with neural network", Color.RED);
        }
        else
        {
    ...
    private void cbxDataStoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxDataStoreActionPerformed
        String item = (String) cbxDataStore.getSelectedItem();
        curDataStore = mapStores.get(item);
