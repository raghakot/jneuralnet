...
import custom.SamplingXYLineRenderer;
...
public class Trainer extends javax.swing.JPanel
{
    ...
    public Trainer()
    {
        ...
        //adding learning algos...
        cbxTrainingAlgo.removeAllItems();
        for(AbstractLearningAlgo algo : cfg.getMapLearningAlgos()
                .getUnWrappedPluginList(AbstractLearningAlgo.class, false))
        {
            cbxTrainingAlgo.addItem(algo.getName());
        }

        //adding cost functions...
        cbxCostFunction.removeAllItems();
        for(AbstractCostFunction cost : cfg.getMapCostFunction()
                .getUnWrappedPluginList(AbstractCostFunction.class, false))
        {
            cbxCostFunction.addItem(cost.getName());
        }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(panelTrainingParameters, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
    ...
    private void btnStopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStopActionPerformed
        ...
        MainWindow.getInstance().setTrainingStatus(false);
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        try
        {
            ...
            AbstractLearningAlgo algo = getLearningAlgo(key);

            //setup cost function to use...
            if(cbxCostFunction.isEnabled())
            {
                key = cbxCostFunction.getSelectedItem().toString();
                algo.setCostFunction(getCostFunction(key));
            }
            ...
            MainWindow.getInstance().setTrainingStatus(true);
    ...
    private void ckbShowTrainingErrorItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ckbShowTrainingErrorItemStateChanged
        boolean isPaused = Configuration.getInstance().getNeuralNetwork()
                .getTeacher().isPaused();
        if(!isPaused)
            btnPause.doClick();
...
private AbstractLearningAlgo getLearningAlgo(String key)
{
    return Configuration.getInstance().getMapLearningAlgos()
            .getUnWrappedPluginMap(AbstractLearningAlgo.class, false)
            .get(key);
}

private AbstractCostFunction getCostFunction(String key)
{
    return Configuration.getInstance().getMapCostFunction()
            .getUnWrappedPluginMap(AbstractCostFunction.class, false)
            .get(key);
}
    ...
    public void trainingCompleted(final Double finalError)
    {
        SwingUtilities.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                MainWindow.getInstance().setTrainingStatus(false);
                MainWindow.getInstance().getStatusBar()
                        .showMessage("Final error : "+finalError);
            }
        });
    }
}
